        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookStoresId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Comment_BookStore_BookStoresId",
                        column: x => x.BookStoresId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX___SeedHistory_Name",
                table: "__SeedHistory",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BookStore_Title_Content",
                table: "BookStore",
